...
namespace eST1C.WebApp.Service
{
    public class LogDataService
    {
        ...
        // Method to fetch and return data from the database
        public async Task<List<LogDataDTO>> GetLogDataAsync()
        {
            // Group by PCName and count the number of occurrences (FrequencyUsed)
        ...
        {
            // Fetch the most recent log for each PC
            return await _context.LogData
                .GroupBy(log => log.PCName)
